"""Experiment 34: Extended LGB+XGB hybrid, more seeds.

exp33 (6LGB+4XGB, 154 feats) gave val=0.2399 -- new best.
Hypothesis: more model diversity with extra seeds should reduce variance further.

Architecture:
  - 5 LGB seeds (42,123,456,789,1234)  alpha=0.52
  - 5 LGB seeds (42,123,456,789,1234)  alpha=0.55
  - 3 XGB seeds (42,123,456)            alpha=0.52
  - 3 XGB seeds (42,123,456)            alpha=0.55
  = 16 models total, per-step calibration, 154 features
"""
...
EXPERIMENT_NAME = "exp34_lgb_xgb_extended"
LGB_SEEDS = [42, 123, 456, 789, 1234]
...
print(f"  5LGB*2alpha + 3XGB*2alpha = 16 models | per-step calib")
